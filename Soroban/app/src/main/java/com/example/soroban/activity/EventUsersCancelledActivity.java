...
public class EventUsersCancelledActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        listData = selectedEvent.getNotGoing();

        // Reference to list view
        listView = findViewById(R.id.usersCancelledView);
        ...
        db.collection("events").document(selectedEvent.getEventName() + ", " + appUser.getDeviceId()).collection("notGoing").addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
